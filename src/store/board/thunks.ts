...
export const boardGetById = createAsyncThunk<IBoard, string, { rejectValue: string }>(
  'boards/getById',
  async (boardId: string, { rejectWithValue }) => {
    try {
...
export const boardGetByIds = createAsyncThunk<IBoard, Array<string>, { rejectValue: string }>(
  'boards/getByIds',
